...
1.  **IA-001 (Detecção de Duplicatas):** Enquanto o aluno digita o título de uma nova dúvida, o sistema realiza uma varredura semântica utilizando Embeddings no banco de dados para identificar perguntas similares já respondidas, mitigando a criação de tópicos repetidos.
2.  **IA-002 (Monitor Virtual Automático):** No exato momento em que uma pergunta é publicada, a API do Groq gera uma resposta técnica inicial. 
